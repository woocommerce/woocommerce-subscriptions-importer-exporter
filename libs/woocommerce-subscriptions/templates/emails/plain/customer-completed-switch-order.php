...
echo sprintf( __( "Hi there. Your subscription change on %s has been completed. Your order details are shown below for your reference:", 'woocommerce-subscriptions' ), get_option( 'blogname' ) ) . "\n\n";

...
echo sprintf( __( 'Customer %s has switched their subscription. Their new subscription information is as follows:', 'woocommerce-subscriptions' ), $order->billing_first_name . ' ' . $order->billing_last_name ) . "\n\n";
